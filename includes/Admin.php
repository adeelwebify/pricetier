  ...
  ?>
    <details class="pricetier-rule" <?php echo $open ? 'open' : ''; ?>>
      ...
      <table class="form-table">
        ...
        <tr>
          <th colspan="2">
            <h3><?php esc_html_e('Products', 'pricetier'); ?></h3>
          </th>
        </tr>
        <tr>
        ...
        <tr>
          <th colspan="2">
            <h3><?php esc_html_e('Users', 'pricetier'); ?></h3>
          </th>
        </tr>
        <tr>
          <th><?php esc_html_e('Apply rule to', 'pricetier'); ?></th>
        ...
        <tr>
          <th colspan="2">
            <h3><?php esc_html_e('Pricing', 'pricetier'); ?></h3>
          </th>
        </tr>
        <tr>
...
<?php
  ...
  private static function handle_post(): void {
    ...
    if (!isset($_POST['pricetier_nonce']) || !wp_verify_nonce($_POST['pricetier_nonce'], 'pricetier_save')) {
      self::add_notice(__('Security check failed', 'pricetier'), 'error');
      return;
    }
